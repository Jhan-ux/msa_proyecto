...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('promocion_eventos')) {
        ...
        if (! Schema::hasTable('promocion_preguntas')) {
        ...
        if (! Schema::hasTable('promocion_opciones')) {
        ...
        if (! Schema::hasTable('promocion_premios')) {
        ...
        if (! Schema::hasTable('promocion_participantes')) {
        ...
        if (! Schema::hasTable('promocion_intentos')) {
        ...
        if (! Schema::hasTable('promocion_respuestas')) {
